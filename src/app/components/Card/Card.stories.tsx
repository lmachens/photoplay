...
export const michaelPena = (): JSX.Element => (
  <Card
    img="https://www.chicagotribune.com/resizer/uurQUI6-FOkyn3of5aduN_NvRPc=/415x562/top/arc-anglerfish-arc2-prod-tronc.s3.amazonaws.com/public/RIQJNIOL5JB7LFE4SQL27KSVJE.jpg"
    artist="Michael Peña"
  />
);
